...
DELETE FROM obstetricsInitRecords;
ALTER TABLE obstetricsInitRecords AUTO_INCREMENT = 0;
DELETE FROM priorPregnancies;
ALTER TABLE priorPregnancies AUTO_INCREMENT = 0;
DELETE FROM obstetricsOfficeVisit;
ALTER TABLE obstetricsOfficeVisit AUTO_INCREMENT = 0;
...
DELETE FROM babyDeliveryInfo;
ALTER TABLE babyDeliveryInfo AUTO_INCREMENT = 0;
