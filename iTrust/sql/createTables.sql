...
CREATE TABLE patients(
	...
	Obstetrics varchar(32) default 'Not Specified',
	RH varchar(32) default 'Not Specified',
	RHImmunization varchar(32) default 'Not Specified',
...
(
	visitID 					BIGINT(20)	UNSIGNED NOT NULL AUTO_INCREMENT,
	obstetricsInitRecordID		BIGINT(20)	UNSIGNED NOT NULL DEFAULT 0,
	locationID					BIGINT(20)	UNSIGNED NOT NULL DEFAULT 0,
	patientMID					BIGINT(20)	UNSIGNED NOT NULL DEFAULT 0,
	hcpMID						BIGINT(20)	UNSIGNED NOT NULL DEFAULT 0,
	apptID						BIGINT(20)	UNSIGNED NOT NULL DEFAULT 0,
	visitDate					DATE 		DEFAULT '1970-01-01',
	weight						FLOAT		DEFAULT 0,
	bloodPressure				INT(10)		SIGNED DEFAULT -1,
	fetalHeartRate				INT(10)		DEFAULT 0,
	lowLyingPlacentaObserved	VARCHAR(32)	DEFAULT 'Not Specified',
	numberOfBabies				INT(2)		DEFAULT 0,
	PRIMARY KEY	(visitID),
	FOREIGN KEY (obstetricsInitRecordID) 	REFERENCES obstetricsInitRecords(recordID),
	FOREIGN KEY (locationID) 				REFERENCES hospitals(HospitalID),
	FOREIGN KEY (patientMID)				REFERENCES patients(MID),
	FOREIGN KEY (hcpMID) 					REFERENCES personnel(MID),
	FOREIGN KEY (apptID) 					REFERENCES appointmenttype(apptType_id)
) ENGINE=MyISAM;
...
(
	...
	obstetricsInitRecordID		BIGINT(20)		UNSIGNED NOT NULL DEFAULT 0,
	apptID						BIGINT(20)		UNSIGNED NOT NULL DEFAULT 0,
	preferredDeliveryMethod		VARCHAR(100)	DEFAULT 'Not Specified',
	hasDelivered				VARCHAR(32)		DEFAULT 'Not Specified',
	pitocinDosage				BIGINT(20) 		UNSIGNED NOT NULL DEFAULT 0,
	pethidineDosage				BIGINT(20) 		UNSIGNED NOT NULL DEFAULT 0,
	nitrousOxideDosage			BIGINT(20) 		UNSIGNED NOT NULL DEFAULT 0,
	epiduralAnaesthesiaDosage	BIGINT(20) 		UNSIGNED NOT NULL DEFAULT 0,
	magnesiumSulfateDosage		BIGINT(20) 		UNSIGNED NOT NULL DEFAULT 0,
	rhImmuneGlobulinDosage		BIGINT(20) 		UNSIGNED NOT NULL DEFAULT 0,
	PRIMARY KEY	(visitID),
	FOREIGN KEY (obstetricsInitRecordID) 	REFERENCES obstetricsInitRecords(recordID),
	FOREIGN KEY (apptID) 					REFERENCES appointmenttype(apptType_id)
) ENGINE=MyISAM;

CREATE TABLE obstetricsInitRecords
(
	recordID			          BIGINT(20)	UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID			        BIGINT(20)	UNSIGNED NOT NULL DEFAULT 0,
	initDate			          DATE		NOT NULL DEFAULT '1970-01-01',
	lastMenstrualPeriod	    DATE NOT NULL DEFAULT '1970-01-01',
...
(
	priorPregnancyID		BIGINT(20)		UNSIGNED NOT NULL AUTO_INCREMENT,
	obstetricRecordID   BIGINT(20)	  UNSIGNED NOT NULL DEFAULT 0,
	yearOfConception		INT(4)			  UNSIGNED NOT NULL DEFAULT 1970,
	daysPregnant 			  INT(3)			  UNSIGNED NOT NULL DEFAULT 0,
	hoursInLabor			  FLOAT			    NOT NULL DEFAULT 0,
  weightGain 				  FLOAT 			  NOT NULL DEFAULT 0,
  deliveryType 			  VARCHAR(100)	DEFAULT 'Not Specified',
	multiplicity			  INT(2)			  UNSIGNED NOT NULL DEFAULT 0,
	PRIMARY KEY (priorPregnancyID),
	FOREIGN KEY (obstetricRecordID) REFERENCES obstetricsInitRecords(recordID)
)  ENGINE=MyISAM;

CREATE TABLE ultrasoundRecords
(
	recordID				BIGINT(20)		UNSIGNED NOT NULL AUTO_INCREMENT,
	obstetricsOfficeVisitID	BIGINT(20)		UNSIGNED NOT NULL DEFAULT 0,
	crownRumpLength			FLOAT			DEFAULT 0.0,
	biparietalDiameter		FLOAT			DEFAULT 0.0,
	headCircumference		FLOAT			DEFAULT 0.0,
	femurLength				FLOAT			DEFAULT 0.0,
	occipitofrontalDiameter	FLOAT			DEFAULT 0.0,
	abdominalCircumference	FLOAT			DEFAULT 0.0,
	humerusLength			FLOAT			DEFAULT 0.0,
	estimatedFetalWeight	FLOAT			DEFAULT 0.0,
	fileURL					VARCHAR(150)	DEFAULT '',
	PRIMARY KEY (recordID),
	FOREIGN KEY (obstetricsOfficeVisitID) REFERENCES obstetricsOfficeVisit(visitID)
)  ENGINE=MyISAM;
...
(
	recordID				BIGINT(20)		UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID      BIGINT(20)		UNSIGNED NOT NULL DEFAULT 0,
	childBirthVisitID		BIGINT(20)		UNSIGNED NOT NULL DEFAULT 0,
	gender					VARCHAR(13) 	DEFAULT 'Not Specified',
	dateOfBirth 			DATETIME,
	deliveryMethod			VARCHAR(100)	DEFAULT 'Not Specified',
	isEstimated				VARCHAR(32)		DEFAULT 'False',
	PRIMARY KEY (recordID),
	FOREIGN KEY (childBirthVisitID) REFERENCES childBirthVisit(visitID)
)  ENGINE=MyISAM;
