...
public class TestDataGenerator {
	...
	/**
	 * generate a list of prior pregnancies for Random Person (MID = 1)
	 */
	public void priorPregnancy1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/priorPregnancy1.sql");
	}
	
	/**
	 * generate a list of obstetrics initialization records for Random Person (MID = 1)
	 */
	public void obstetricsInit1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obstetricsInit1.sql");
	}
	
	/**
	 * generate a list of obstetrics initialization records for Random Person (MID = 2)
	 */
	public void obstetricsInit2() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obstetricsInit2.sql");
	}
	
	/**
	 * generate a list of obstetrics office visits for Random Person (MID = 1)
	 */
	public void obstetricsOfficeVisit1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obstetricsOfficeVisit1.sql");
	}
	
	/**
	 * generate a list of ultrasound records for Random Person (MID = 1)
	 */
	public void ultrasoundRecords1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/ultrasoundRecords1.sql");
	}

	/**
	 * generate a list of child birth visits for Random Person (MID = 1)
	 */
	public void childBirthVisit1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/childBirthVisit1.sql");
	}

	public void childBirthVisit3() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/childBirthVisit3.sql");
	}

	/**
	 * generate a list of child birth visits for Random Person (MID = 1)
	 */
	public void babyDeliveryInfo1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/babyDeliveryInfo1.sql");
	}
