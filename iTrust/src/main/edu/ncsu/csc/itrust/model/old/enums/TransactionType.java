...
public enum TransactionType {
	...
	/**Create Initial Obstetric Record**/
	INITIAL_OBSTETRIC_RECORD_CREATE(9300,"Create Initial Obstetric Record","Create Initial Obstetric Record", true),
	/**View Initial Obstetric Record**/
	INITIAL_OBSTETRIC_RECORD_VIEW(9301, "View Initial Obstetric Record","View Initial Obstetric Record", true),
	...
	/**EDIT_ULTRASOUND_RECORD**/
	EDIT_ULTRASOUND_RECORD(9403, "Edit Ultrasound Record", "Edit Ultrasound Record", true),
	...
	/**VIEW_LABOR_DELIVERY_REPORT**/
	VIEW_LABOR_DELIVERY_REPORT(9500, "View Labor Delivery Record", "View Labor Delivery Record", true),
	/**CREATE_CHILDBIRTH_VISIT**/
	CREATE_CHILDBIRTH_VISIT(9600, "Create Childbirth Visit Record", "Create Childbirth Visit Record", true),
	...
	/**CREATE_BABY_RECORD**/
	CREATE_BABY_RECORD(9603, "Create Baby Patient Record", "Create Baby Patient Record", true),
