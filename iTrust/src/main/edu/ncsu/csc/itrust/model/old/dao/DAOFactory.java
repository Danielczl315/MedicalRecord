...
//	}
	...
	/**
	 * 
	 * @return this DAOFactory's ObstetricsInitDAO
	 */
	public ObstetricsInitDAO getObstetricsInitDAO() {
		return new ObstetricsInitDAO(this);
	}
	
	/**
	 * 
	 * @return this DAOFactory's PriorPregnanciesDAO
	 */
	public PriorPregnancyDAO getPriorPregnancyDAO() {
		return new PriorPregnancyDAO(this);
	}
	
	/**
	 * 
	 * @return this DAOFactory's ObstetricsOfficeVisitDAO
	 */
	public ObstetricsOfficeVisitDAO getObstetricsOfficeVisitDAO()
	{
		return new ObstetricsOfficeVisitDAO(this);
	}
