...
public class PatientBean implements Serializable, Comparable<PatientBean> {
	...
	private Obstetrics obstetrics = Obstetrics.NotSpecified;
	private BooleanType RH = BooleanType.NotSpecified;
	private BooleanType RHImmunization = BooleanType.NotSpecified;
	...
	public Obstetrics getObstetrics() {
		return obstetrics;
	}

	public void setObstetricsStr(String obstetrics) {
		this.obstetrics = Obstetrics.parse(obstetrics);
	}

	public void setObstetrics(Obstetrics obstetrics) {
		this.obstetrics = obstetrics;
	}
	
	public BooleanType getRH() {
		return RH;
	}

	public void setRHStr(String RH) {
		this.RH = BooleanType.parse(RH);
	}

	public void setRH(BooleanType RH) {
		this.RH = RH;
	}
	
	public BooleanType getRHImmunization() {
		return RHImmunization;
	}

	public void setRHImmunizationStr(String RHImmunization) {
		this.RHImmunization = BooleanType.parse(RHImmunization);
	}

	public void setRHImmunization(BooleanType RHImmunization) {
		this.RHImmunization = RHImmunization;
	}
