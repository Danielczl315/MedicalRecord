...
<title><%=StringEscapeUtils.escapeHtml("" + (pageTitle))%></title>
	...
	<%--Dynamic tables code dervived from https://www.tutorialrepublic.com/snippets/preview.php?topic=bootstrap&file=table-with-add-and-delete-row-feature--%>
	<%--Used in various files that need dynamic tables to input data--%>
	<%--The following resources are used for dynamic tables, to add, to edit, and to delete.--%>
