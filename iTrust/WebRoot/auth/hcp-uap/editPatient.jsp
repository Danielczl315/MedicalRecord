...
<%@ page import="edu.ncsu.csc.itrust.model.old.enums.*" %>
...
<table cellspacing=0 align=center cellpadding=0>
	<tr>
		...
		<table class="fTable" align=center style="width: 350px;">
			...
			<tr>
				<td class="subHeaderVertical">Obstetrics Elgibility:</td>
				<td><select name="obstetricsStr">

					<%
						String defaultSelect = "";
						for (Obstetrics type : Obstetrics.values()) {
							defaultSelect = (type.equals(p.getObstetrics())) ? "selected=selected"
									: "";
					%>
					<option value="<%=type.getName()%>" <%= StringEscapeUtils.escapeHtml("" + (defaultSelect)) %>><%= StringEscapeUtils.escapeHtml("" + (type.getName())) %></option>
					<%
						}
					%>
				</select>
